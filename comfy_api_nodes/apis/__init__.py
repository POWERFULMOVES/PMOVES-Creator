...
#   timestamp: 2026-02-23T01:25:57+00:00
...
class KlingMotionControlRequest(BaseModel):
    ...
    model_name: ModelName2 | None = Field(
        'kling-v2-6',
        description='Model name for motion control. Currently only supports kling-v2-6.',
    )
...
class WatermarkInfo3(BaseModel):
    enabled: bool | None = None
...
class LTXImage2VideoRequest(BaseModel):
    ...
    resolution: Resolution2 = Field(..., description='Output video resolution')
...
class MinimaxVideoGenerationRequest(BaseModel):
    ...
    resolution: Resolution4 | None = Field(
...
class RecraftImageGenerationResponse(BaseModel):
    ...
    data: list[Datum4] = Field(..., description='Array of generated image information')
...
class StabilityImageGenerationSD3Request(BaseModel):
    ...
    output_format: OutputFormat4 | None = Field(
...
class StabilityImageGenrationUpscaleConservativeRequest(BaseModel):
    creativity: StabilityCreativity | None = Field(
        default_factory=lambda: StabilityCreativity(0.35)
    )
    image: bytes = Field(
        ...,
...
class TencentFile3D(BaseModel):
    ...
    Type: Type42 | None = Field(None, description='3D file format')
...
class TencentInputFile3D(BaseModel):
    Type: Type43 = Field(..., description='3D file format type', examples=['GLB'])
    Url: AnyUrl = Field(
        ...,
...
class TopazEnhanceGenRequest(BaseModel):
    ...
    output_format: OutputFormat8 | None = Field(
...
class TopazOutputInformationImageSequence(BaseModel):
    ...
    resolution: Resolution7 = Field(..., description='Desired output resolution')
...
class TopazStatusResponse(BaseModel):
    ...
    status: Status18 = Field(..., description='Current status of the processing job')
...
class Instance1(BaseModel):
    ...
    lastFrame: LastFrame | LastFrame1 | None = Field(
        None, description='Optional last frame image to guide video generation'
    )
    prompt: str = Field(..., description='Text description of the video')
...
class Input2(BaseModel):
    ...
    prompt: constr(max_length=800) = Field(
        ...,
...
class Duration9(IntEnum):
    integer_5 = 5
    integer_10 = 10
    integer_15 = 15


class Resolution9(str, Enum):
    field_480P = '480P'
    field_720P = '720P'
    field_1080P = '1080P'
...
class Parameters4(BaseModel):
    ...
    resolution: Resolution9 | None = Field(
        None,
...
class Data15(BaseModel):
    ...
    status: Status21 | None = Field(None, description='Status of the task')
...
class XAIGeneratedImage(BaseModel):
    b64_json: str | None = Field(
        None, description='Base64-encoded image (if response_format is b64_json)'
    )
    revised_prompt: str | None = Field(
        None, description='The enhanced prompt used for generation'
    )
    url: str | None = Field(
        None, description='URL to the generated image (if response_format is url)'
    )
...
class XAIGeneratedVideo(BaseModel):
    ...
    upsampled_prompt: str | None = Field(
        None, description='The enhanced prompt used for generation'
    )
    url: str | None = Field(None, description='URL to the generated video (MP4)')
...
class XAIImageGenerationRequest(BaseModel):
    aspect_ratio: AspectRatio5 | None = Field(
        '1:1', description='Aspect ratio of the generated image'
    )
    model: str | None = Field(
        'grok-imagine-image-beta', description='Model to use for generation'
    )
    n: conint(ge=1, le=10) | None = Field(
        1, description='Number of images to generate (1-10)'
    )
    prompt: constr(max_length=10000) = Field(
        ..., description='Text description of the desired image. Max 10,000 characters.'
    )
    response_format: ResponseFormat | None = Field('url', description='Return format')


class XAIImageGenerationResponse(BaseModel):
    data: list[XAIGeneratedImage] | None = None
...
class XAIVideoObject(BaseModel):
    url: str = Field(
        ...,
        description='URL of the input video (public URL or base64-encoded data URI)',
    )
...
class XAIVideoPendingResponse(BaseModel):
    status: Status24 | None = Field(None, description='Current status')
...
class KlingImage2VideoRequest(BaseModel):
    ...
    cfg_scale: KlingVideoGenCfgScale | None = Field(
        default_factory=lambda: KlingVideoGenCfgScale(0.5)
    )
    ...
    mode: KlingVideoGenMode | None = 'std'
    model_name: KlingVideoGenModelName | None = 'kling-v2-master'
    multi_prompt: list[MultiPromptItem] | None = Field(
        None,
        description='Information about each storyboard, such as prompts and duration. Supports up to 6 storyboards, with a minimum of 1. Required when multi_shot is true and shot_type is customize.',
    )
    ...
    watermark_info: WatermarkInfo | None = Field(
        None,
        description='Whether to generate watermarked results simultaneously. Custom watermark is not supported at this time.',
    )
...
class Data7(BaseModel):
    ...
    watermark_info: WatermarkInfo3 | None = None


class KlingOmniVideoResponse(BaseModel):
    code: int | None = Field(None, description='Error code')
...
class KlingText2VideoRequest(BaseModel):
    ...
    watermark_info: WatermarkInfo4 | None = Field(
        None,
        description='Whether to generate watermarked results simultaneously. Custom watermark is not supported at this time.',
    )
...
class Data9(BaseModel):
    ...
    watermark_info: WatermarkInfo5 | None = None
...
class Source(BaseModel):
    ...
    resolution: Resolution5 = Field(..., description='Resolution details of the image')
...
class Source1(BaseModel):
    ...
    frameRate: float = Field(..., description='Frame rate of the video', examples=[30])
    resolution: Resolution6 = Field(..., description='Resolution details of the video')
    size: int = Field(
...
class XAIImageEditRequest(BaseModel):
    ...
    model: str | None = Field(
        'grok-imagine-image-beta', description='Model to use for editing'
    )
    n: conint(ge=1, le=10) | None = Field(
        1, description='Number of edited images to generate (1-10)'
    )
    prompt: constr(max_length=10000) = Field(
        ..., description='Text description of the desired edit. Max 10,000 characters.'
    )
    resolution: Resolution10 | None = Field(
        '1k', description='Resolution of the output image'
    )
    response_format: ResponseFormat | None = Field('url', description='Return format')
...
class XAIVideoEditRequest(BaseModel):
    model: str | None = Field(
        'grok-imagine-video-beta', description='Model to use for editing'
    )
    prompt: str = Field(
        ...,
        description='Text description of the desired edit (e.g., "Make it snowy", "Change the car to red")',
    )
