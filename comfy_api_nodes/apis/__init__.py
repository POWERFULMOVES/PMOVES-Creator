...
#   timestamp: 2026-05-11T02:31:00+00:00
...
class BriaStatusResponse(BaseModel):
    ...
    status: Status1 | None = Field(None, description='Current status of the request.')
...
class BytePlusImageGenerationResponse(BaseModel):
    ...
    error: Error2 | None = Field(None, description='Error information (if any)')
...
class BytePlusVideoGenerationContent(BaseModel):
    ...
    type: Type = Field(..., description='The type of the input content')
...
class BytePlusVideoGenerationQueryResponse(BaseModel):
    ...
    status: Status3 | None = Field(None, description='The state of the task')
...
class GithubUser(BaseModel):
    ...
    type: Type9 = Field(..., description='The type of user')
...
class ResourcePackSubscribeInfo(BaseModel):
    ...
    status: Status10 | None = Field(None, description='Resource Package Status')
...
class LTXImage2VideoRequest(BaseModel):
    ...
    resolution: Resolution3 = Field(..., description='Output video resolution')
...
class MinimaxVideoGenerationRequest(BaseModel):
    ...
    resolution: Resolution5 | None = Field(
...
class OutputAudioContent(BaseModel):
    ...
    type: Type24 = Field(..., description='The type of output content')
...
class OutputTextContent(BaseModel):
    ...
    type: Type26 = Field(..., description='The type of output content')
...
class ResponseErrorEvent(BaseModel):
    ...
    type: Type33 = Field(..., description='The type of the event. Always `error`.\n')
...
class ResponseUsage(BaseModel):
    ...
    output_tokens_details: OutputTokensDetails1 = Field(
...
class StabilityImageGenerationSD3Request(BaseModel):
    aspect_ratio: AspectRatio7 | None = Field(
        '1:1',
...
class TencentFile3D(BaseModel):
    ...
    Type: Type47 | None = Field(None, description='3D file format')
...
class TencentInputFile3D(BaseModel):
    Type: Type48 = Field(..., description='3D file format type', examples=['GLB'])
    Url: AnyUrl = Field(
        ...,
...
class TopazOutputInformationImageSequence(BaseModel):
    ...
    resolution: Resolution8 = Field(..., description='Desired output resolution')
...
class TopazStatusResponse(BaseModel):
    ...
    status: Status21 = Field(..., description='Current status of the processing job')
...
class Veo2GenVidPollResponse(BaseModel):
    ...
    error: Error9 | None = Field(None, description='Error details if operation failed')
    name: str | None = None
...
class Instance1(BaseModel):
    ...
    video: Video2 | Video3 | None = Field(
        None,
...
class Parameters1(BaseModel):
    aspectRatio: AspectRatio8 | None = Field(
        None,
    ...
    resolution: Resolution10 | None = Field(
        None,
...
class MediaItem(BaseModel):
    type: Type52 = Field(..., description='Media asset type')
    url: str = Field(
        ...,
...
class Data14(BaseModel):
    ...
    status: Status24 | None = Field(None, description='Status of the task')
...
class XAIImageGenerationRequest(BaseModel):
    aspect_ratio: AspectRatio9 | None = Field(
        'auto',
...
class XAIImageObject(BaseModel):
    type: Type55 | None = Field(None, description='Type of the image input')
    url: str = Field(
        ...,
...
class XAIVideoGenerationRequest(BaseModel):
    aspect_ratio: AspectRatio11 | None = Field(
...
class MeshyAnimationTask(BaseModel):
    ...
    type: Type17 | None = Field(None, description='Type of the Animation task.')
...
class MeshyImageTo3DTask(BaseModel):
    ...
    type: Type18 | None = Field(None, description='Type of the Image to 3D task.')
...
class MeshyMultiImageTo3DTask(BaseModel):
    ...
    type: Type19 | None = Field(None, description='Type of the Multi-Image to 3D task.')
...
class MeshyRemeshTask(BaseModel):
    ...
    task_error: MeshyTaskError | None = None
    type: Type20 | None = Field(None, description='Type of the Remesh task.')
...
class MeshyRetextureTask(BaseModel):
    ...
    type: Type21 | None = Field(None, description='Type of the Retexture task.')
...
class MeshyRiggingTask(BaseModel):
    ...
    status: MeshyTaskStatus
    task_error: MeshyTaskError | None = None
    type: Type22 | None = Field(None, description='Type of the Rigging task.')
...
class MeshyTextTo3DTask(BaseModel):
    ...
    type: Type23 | None = Field(None, description='Type of the Text to 3D task.')
    video_url: str | None = Field(
        None,
...
class OutputMessage(BaseModel):
    ...
    role: Role5 = Field(..., description='The role of the message')
    type: Type25 = Field(..., description='The type of output item')
...
class ReveImageCreateRequest(BaseModel):
    aspect_ratio: AspectRatio4 | None = Field(
...
class Rodin3DGenerateRequest(BaseModel):
    addons: list[str] | None = Field(
        None, description='Optional list of upstream addon flags (e.g. "HighPack").'
    )
...
class Rodin3DGenerateResponse(BaseModel):
    ...
    submit_time: str | None = Field(None, description='Time')
...
class Source(BaseModel):
    ...
    resolution: Resolution6 = Field(..., description='Resolution details of the image')
...
class Source1(BaseModel):
    ...
    frameRate: float = Field(..., description='Frame rate of the video', examples=[30])
    resolution: Resolution7 = Field(..., description='Resolution details of the video')
    size: int = Field(
...
class BulkNodeVersionResult(BaseModel):
    ...
    status: Status2 = Field(..., description='Status of the retrieval operation')
...
class GeminiContent(BaseModel):
    ...
    role: Role2 = Field(..., examples=['user'])
