...
#   timestamp: 2026-02-02T01:26:13+00:00
...
class GithubUser(BaseModel):
    ...
    type: Type8 = Field(..., description='The type of user')
...
class KlingImageGenerationsRequest(BaseModel):
    ...
    n: conint(ge=1, le=9) | None = Field(1, description='Number of generated images')
    negative_prompt: constr(max_length=200) | None = Field(
...
class LTXImage2VideoRequest(BaseModel):
    ...
    resolution: Resolution1 = Field(..., description='Output video resolution')
...
class MinimaxVideoGenerationRequest(BaseModel):
    ...
    resolution: Resolution3 | None = Field(
...
class OutputAudioContent(BaseModel):
    ...
    type: Type23 = Field(..., description='The type of output content')
...
class OutputTextContent(BaseModel):
    ...
    type: Type25 = Field(..., description='The type of output content')
...
class ResponseErrorEvent(BaseModel):
    ...
    type: Type32 = Field(..., description='The type of the event. Always `error`.\n')
...
class TencentFile3D(BaseModel):
    ...
    Type: Type41 | None = Field(None, description='3D file format')
    Url: AnyUrl | None = Field(None, description='File URL (valid for 24 hours)')


class TencentHunyuan3DProQueryRequest(BaseModel):
    JobId: str = Field(
        ...,
...
class TencentHunyuan3DProQueryResponse(BaseModel):
...
class TopazOutputInformationImageSequence(BaseModel):
    ...
    resolution: Resolution6 = Field(..., description='Desired output resolution')
...
class Veo2GenVidPollResponse(BaseModel):
    ...
    error: Error8 | None = Field(None, description='Error details if operation failed')
    name: str | None = None
    response: Response3 | None = Field(
...
class Parameters4(BaseModel):
    ...
    resolution: Resolution8 | None = Field(
        None,
...
class MeshyAnimationTask(BaseModel):
    ...
    type: Type16 | None = Field(None, description='Type of the Animation task.')
...
class MeshyImageTo3DTask(BaseModel):
    ...
    type: Type17 | None = Field(None, description='Type of the Image to 3D task.')
...
class MeshyMultiImageTo3DTask(BaseModel):
    ...
    type: Type18 | None = Field(None, description='Type of the Multi-Image to 3D task.')
...
class MeshyRemeshTask(BaseModel):
    ...
    task_error: MeshyTaskError | None = None
    type: Type19 | None = Field(None, description='Type of the Remesh task.')
...
class MeshyRetextureTask(BaseModel):
    ...
    type: Type20 | None = Field(None, description='Type of the Retexture task.')
...
class MeshyRiggingTask(BaseModel):
    ...
    status: MeshyTaskStatus
    task_error: MeshyTaskError | None = None
    type: Type21 | None = Field(None, description='Type of the Rigging task.')
...
class MeshyTextTo3DTask(BaseModel):
    ...
    type: Type22 | None = Field(None, description='Type of the Text to 3D task.')
    video_url: str | None = Field(
        None,
...
class OutputMessage(BaseModel):
    ...
    type: Type24 = Field(..., description='The type of output item')
...
class Rodin3DDownloadResponse(BaseModel):
    list: list[RodinResourceItem] | None = None
...
class Source(BaseModel):
    ...
    resolution: Resolution4 = Field(..., description='Resolution details of the image')
...
class Source1(BaseModel):
    ...
    frameRate: float = Field(..., description='Frame rate of the video', examples=[30])
    resolution: Resolution5 = Field(..., description='Resolution details of the video')
    size: int = Field(
